...
* **medallion**: concesión otorgada a un taxi amaraillo por la ciudad de NY para poder circular  (los famosos Yellow Cabs). Se puede utilizar como identificador del taxi. Más información en https://en.wikipedia.org/wiki/Taxicabs_of_New_York_City#Medallions
* **hack_license**: la licencia que permite identificar a cada conductor. Más información en http://nycitycab.com/HackLicense.aspx
