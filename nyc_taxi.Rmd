...
https://www.dropbox.com/s/nmtodtuvpb8f87d/trip_data_2013-01-14.csv?dl=0
...
* **medallion**: concesión otorgada a un taxista por la ciudad de NY para poder operar un taxi amarillo (los famosos Yellow Cabs). Se puede utilizar como identificador del conductor. Más información en https://en.wikipedia.org/wiki/Taxicabs_of_New_York_City#Medallions
* **hack_license**: la licencia que permite identificar a cada taxi. Más información en http://nycitycab.com/HackLicense.aspx
...
```{r}
medallions <- as.data.frame(table(df$medallion))
plot1 <- ggplot(medallions, aes(Freq)) + stat_ecdf()
plot2 <- ggplot(medallions, aes(Freq)) + geom_histogram(binwidth = 5)
...
https://www.dropbox.com/s/lowbxfx2uohlxy3/All_Starbucks_Locations_in_the_US_2013.csv?dl=0
